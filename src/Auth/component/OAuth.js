...
const OAuth = ({ setIsLogin, setUsername }) => {
  const handleGoogle = () => {
    ...
    <div>
      ...
      <div className="mt-4 flex space-x-2">
        ...
        >
          ...
          <span className="text-lg text-gray-950 font-semibold">Google</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-lg text-gray-950 font-semibold">GitHub</span>
        </button>
      </div>
    </div>
  );
